...
def analisar_e_operar():
    try:
        ...
        # Verifica cruzamento e confirmação
        cruzamento_alta = ema20.iloc[-3] < ema50.iloc[-3] and ema20.iloc[-2] > ema50.iloc[-2]
        cruzamento_baixa = ema20.iloc[-3] > ema50.iloc[-3] and ema20.iloc[-2] < ema50.iloc[-2]
        confirmacao_alta = cruzamento_alta and df['close'].iloc[-1] > ema50.iloc[-1]
        confirmacao_baixa = cruzamento_baixa and df['close'].iloc[-1] < ema50.iloc[-1]
